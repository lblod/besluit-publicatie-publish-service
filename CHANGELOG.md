...
- [#16](https://github.com/lblod/besluit-publicatie-publish-service/pull/16) Add linked decision to the predicates to be parsed ([@lagartoverde](https://github.com/lagartoverde))
